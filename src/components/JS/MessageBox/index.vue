...
<style scoped>
    .messageBox{width: 200px;height: 120px;border: 1px solid #ccc;border-radius: 4px;background: #fff;box-shadow: 3px 3px 3px 3px #eee;position: absolute;left: 50%;top: 50%;margin: -60px 0 0 -100px;}
